...
# 2. Type your new single commit message (e.g., "Initial commit").
# 3. Save and close Notepad.
...
# Outcome
Your repository now has a single clean commit ("Initial commit").  
When you make it public, only this commit will be visible
